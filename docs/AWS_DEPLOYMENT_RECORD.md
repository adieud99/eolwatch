...
기준일: 2026-09-15. **과거 기록이다.** 현재 시연은 로컬 관리 VM 1대·대상 VM 2대이며 이 AWS 환경의 현재 실행 상태를 보증하지 않는다.
...
4. ~~Teams Workflow URL을 제공받으면 실제 알림 전송을 확인한다.~~ Teams 알림 기능은 2026-09-18 재범위화에서 제거했다.
